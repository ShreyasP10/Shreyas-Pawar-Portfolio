...
export function LeetCodeIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M13.48 1.04a1.32 1.32 0 0 1 1.87 0l8.06 8.06c.3.3.46.71.46 1.14s-.16.84-.46 1.14l-2.65 2.65-1.87-1.87 1.96-1.96-7.6-7.6-2.24 2.24-1.87-1.87 2.34-2.33zM1.26 15.74a1.32 1.32 0 0 1 0-1.87l3.28-3.28 1.87 1.87-2.59 2.6h9.25a1.32 1.32 0 0 1 0 2.64H3.82l2.59 2.59-1.87 1.87-3.28-3.28c-.5-.5-.5-1.3 0-1.87z" />
      <path d="M10.22 10.2a1.32 1.32 0 0 1 0 2.64H6.95l-.02-2.64h3.29z" />
    </svg>
  );
}
